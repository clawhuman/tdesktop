...
option(INTERNAL_TELEGRAM "Build the transparent enterprise-managed client." OFF)
set(INTERNAL_TELEGRAM_CONTROL_URL "" CACHE STRING "Managed control URL.")
set(INTERNAL_TELEGRAM_ENVELOPE_KEY_ID "" CACHE STRING "Managed envelope key ID.")
set(INTERNAL_TELEGRAM_ENVELOPE_PUBLIC_KEY "" CACHE STRING "Base64 RSA public key.")
set(INTERNAL_TELEGRAM_POLICY_PUBLIC_KEY "" CACHE STRING "Base64 Ed25519 public key.")
set(INTERNAL_TELEGRAM_CA_CERTIFICATE "" CACHE STRING "Base64 pinned CA certificate.")
set(INTERNAL_TELEGRAM_SOURCE_URL "" CACHE STRING "Corresponding source URL.")

if (INTERNAL_TELEGRAM)
    foreach(required_option
        INTERNAL_TELEGRAM_CONTROL_URL
        INTERNAL_TELEGRAM_ENVELOPE_KEY_ID
        ...
        if ("${${required_option}}" STREQUAL "")
            message(FATAL_ERROR "${required_option} is required for INTERNAL_TELEGRAM.")
        endif()
    endforeach()
    target_compile_definitions(Telegram PRIVATE
        INTERNAL_TELEGRAM
        INTERNAL_TELEGRAM_CONTROL_URL="${INTERNAL_TELEGRAM_CONTROL_URL}"
        INTERNAL_TELEGRAM_ENVELOPE_KEY_ID="${INTERNAL_TELEGRAM_ENVELOPE_KEY_ID}"
        INTERNAL_TELEGRAM_ENVELOPE_PUBLIC_KEY="${INTERNAL_TELEGRAM_ENVELOPE_PUBLIC_KEY}"
        INTERNAL_TELEGRAM_POLICY_PUBLIC_KEY="${INTERNAL_TELEGRAM_POLICY_PUBLIC_KEY}"
        INTERNAL_TELEGRAM_CA_CERTIFICATE="${INTERNAL_TELEGRAM_CA_CERTIFICATE}"
        INTERNAL_TELEGRAM_SOURCE_URL="${INTERNAL_TELEGRAM_SOURCE_URL}"
    )
endif()
